...
Public Sub SetCombo(ComboName As ComboBox, Value As Long)
    ...
    Do While ComboName.ItemData(ComboName.ListIndex) <> Value _
    And ComboName.ListIndex < ComboName.ListCount - 1
...
Public Function ValidateInput(Value As TextBox, isLong As Boolean, Optional isChange As Boolean, _
                              Optional DeadRange As Byte) As Boolean
