...
Private Sub cboName_Click()
    Dim ar As Long: ar = GetOffsetAddress(cboName.ListIndex)
...
Private Sub cmdExport_Click()
    ...
    Stringo = Stringo & vbNewLine & vbNewLine _
        & "HP " & txtHP.Text & " - " _
        & txtHpProjected.Text & " " & cboHpGrowth.Text
    Stringo = Stringo & vbNewLine & "MP " & txtMP.Text _
        & " - " & txtMpProjected.Text & " " & cboMpGrowth.Text
    Stringo = Stringo & vbNewLine & "AT " & txtAtk.Text _
        & " - " & txtAtkProjected.Text & " " & cboAtkGrowth.Text
    Stringo = Stringo & vbNewLine & "DF " & txtDef.Text _
        & " - " & txtDefProjected.Text & " " & cboDefGrowth.Text
    Stringo = Stringo & vbNewLine & "AG " & txtAGI.Text _
        & " - " & txtAgiProjected.Text & " " & cboAgiGrowth.Text
