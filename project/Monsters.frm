...
Private Sub cboName_Click()
    ...
    For Index = 0 To 55
        Text1.Text = Text1.Text & Align(RomDump(cboName.ItemData(cboName.ListIndex) + Index)) _
            & RomDump(cboName.ItemData(cboName.ListIndex) + Index) & " "
...
'   Next Index
    ...
    Dim AtkChances As Byte: AtkChances = RomDump(Address + 30)
...
Private Function Align(b As Byte) As String
    If b < 10 Then
        Align = "  "
    ElseIf b < 100 Then
        Align = " "
...
Private Sub txtNameData_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 13 Then
        txtNameData.Text = Left(txtNameData.Text, txtNameData.SelStart - 2) _
            & Right(txtNameData.Text, Len(txtNameData.Text) - txtNameData.SelStart)
    End If
End Sub
