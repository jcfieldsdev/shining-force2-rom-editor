...
Private Sub cmdChart_Click()
    If ValidateInput(txtAtk, False) = True _
    And ValidateInput(txtDef, False) = True _
    And ValidateInput(txtLE, False) = True _
    And ValidateInput(txtCritical, False) = True Then
